...
public:
  ...
  inline bool getEnhancedScc() const;
...
public:
  ...
  inline bool getEnhancedScc();
  inline void setEnhancedScc(bool value);
...
inline bool CarParams::Reader::getLatActive() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<994>() * ::capnp::ELEMENTS);
}

inline bool CarParams::Builder::getLatActive() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<994>() * ::capnp::ELEMENTS);
}
inline void CarParams::Builder::setLatActive(bool value) {
  _builder.setDataField<bool>(
      ::capnp::bounded<994>() * ::capnp::ELEMENTS, value);
}

inline bool CarParams::Reader::getEnhancedScc() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<995>() * ::capnp::ELEMENTS);
}

inline bool CarParams::Builder::getEnhancedScc() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<995>() * ::capnp::ELEMENTS);
}
inline void CarParams::Builder::setEnhancedScc(bool value) {
  _builder.setDataField<bool>(
