...
def create_acc_commands(packer, enabled, accel, starting, idx, lead_visible, set_speed, stopping, gas_pressed, main_enabled, escc, tau_gap_set):
  commands = []
  ...
  scc14_values = {
    ...
    "JerkUpperLimit": 12.7, # stock usually is 1.0 but sometimes uses higher values
    "JerkLowerLimit": 12.7, # stock usually is 0.5 but sometimes uses higher values
